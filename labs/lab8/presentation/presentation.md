...
![Реализация алгоритма 1](image/1.PNG){ #fig:001 width=70% height=70% }

## Реализация алгоритма 1 (сложение неотрицательных целых чисел)

![Реализация алгоритма 1](image/2.PNG){ #fig:002 width=70% height=70% }

## Реализация алгоритма 2 (вычитание неотрицательных целых чисел)

![Реализация алгоритма 2](image/3.PNG){ #fig:003 width=70% height=70% }

## Реализация алгоритма 3 (умножение неотрицательных целых чисел столбиком)

![Реализация алгоритма 3](image/4.PNG){ #fig:004 width=70% height=70% }

## Реализация алгоритма 5 (деление многоразрядных целых чисел)

![Реализация алгоритма 5](image/5.PNG){ #fig:005 width=70% height=70% }
...
- В ходе выполнения лабораторной работы были изучены алгоритмы для выполнения арифметических операций с большими целыми числами, а также
